# Script RieXGH (V1-Websocket)
 Welcome Dear😊

 <h2 align="center">AutoScript VPN By RieXGH <img src="https://img.shields.io/badge/Version-1.0-blue.svg"></h2>
...
## INSTALLATION SCRIPT
  ...
  ```html
  sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/ZamXYZ2022/ws/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
...
[RieXGH](https://t.me/mintpulut)

[Group RieXGH](https://t.me/)

[Channel V-Code](https://t.me/)
